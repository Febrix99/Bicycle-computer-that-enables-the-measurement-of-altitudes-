...
Obj_Display.dlugosc_smugi = const(38)     # Długość smugi     [w pixelach]
Obj_Display.dlugosc_wskaznia = const(49)  # Długość Wskaźnika [w pixelach]
...
####============ Prędkość Chwilowa ======================================================####        
        ...
        if Licznik.time_beetwen  > 2_000 and Licznik.Odliczanie_impulsow > 0:
            Licznik.over_2s_and_speed_non_0()
            
        elif Licznik.time_beetwen  > 2_000 and Licznik.Odliczanie_impulsow == 0: # osobny if, po to, żeby 'time_beetwen' był większy niż 3s, czyli pierwszy impuls z koła nie dał dużej prędkości chwilowej
            Licznik.over_2s_and_speed_0()
...
####============ Wyświetlacz ============================================================####
        ...
        if Obj_Menu.menu == False:
            ...
            #======== Wejście do Menu ===================#
            if Obj_Menu.przytrzymanie_przycisku(3,750) == 3:
                Menu.wejscie_do_Menu(Obj_Menu,Obj_Display)
                
            #======== Wrócenie do głównej funkcji =======#                         
            elif Obj_Menu.time_beetwen_interaction_przycisk > 10_000 and Obj_Menu.warunek_ktory_wyswietlacz != 0:
                Obj_Menu.warunek_ktory_wyswietlacz = 0 
...
###============ Kadencja ================================================================####
        if time.ticks_diff(time.ticks_ms() ,Licznik.finish_cadence) > 3000 :
            Licznik.cadence_over_3s()
###============ Sleep Mode ==============================================================####
        ##======  Pójście spać jeżeli od ostatniej interakcji mineło więcej niż 'N's ===##        
        if Licznik.time_beetwen > 20_000  and Obj_Menu.time_beetwen_interaction_przycisk > 20_000:
