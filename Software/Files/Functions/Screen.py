    ...
    def show_picture(self, obj_menu):
        if obj_menu.zmiana_przycisk == True:
            ...
            if obj_menu.warunek_ktory_wyswietlacz ==1:
                ...
                IPS.jpg('/Libraries/Pictures/v_max.jpg' ,30,0, st7789.SLOW)          #105x105
        ...
        if self.wyswietlana_predkosc_speedometer != predkosc:
            ...
            if obj_menu.interwal_czas_start_0 == True:
                ...
                if speed > 9:
                    ...
                    x = 175
                    x_1 = 110
                IPS.fill_rect(83,118,165,75,st7789.BLACK)
                IPS.draw(romand, str(speed), x_1, 160, self.motyw_czcionki(self.kolor_czcionki), 3.2)
                IPS.draw(romand, str(zaokraglenie), x, 144, self.motyw_czcionki(self.kolor_czcionki), 1.8)
        ...
        ### Ta część kodu zajmuję najwięcej czasu, ok 8ms z 11 ms okresu  ###
            for i in dlugosc_lini:
                ...
                if arg1 <= self.dlugosc_smugi and self.pochodna == True:
                    ...
                    IPS.pixel(x1+x_prim   ,y1 + i+1,    Display.kolor_smugi(wybor,arg1,pozycja_kolor))
                else:

                    IPS.pixel(x1+x_prim     ,y1 + i,    st7789.BLACK)
                    IPS.pixel(x1+x_prim     ,y1 + i+1,    st7789.BLACK)
            ...
            for i in dlugosc_lini:
                ...
                if arg1 <= self.dlugosc_smugi and self.pochodna == True :
                    ...
                    if x1 <= x2 :
                        ...
                        IPS.pixel(x1+i+1,y1 + y_prim, st7789.BLACK)
                    else:
