...
class Menu():   
    ...
    alrm_przycisk_1,alrm_przycisk_2,powrot_menu          = False, False, False
#################################### FUNKCJE PRZERWANIA ##########################################################################################    
    ...
    def interwal_dane(self, ope):
        if self.wlasny_interwal == False and self.wybor_w_menu_interwal == 0: # Wybór gotowego interwału 
          ...
          # Wybór własnego interwału dystansowego                  
            ...
            if self.wybor_w_menu_interwal == 0:
                if self.interwal_dystans <= 10:
                    self.interwal_dystans = 10
                if self.interwal_dystans <= 100:
                    if self.interwal_dystans == 10 and ope.__name__ == 'sub':
                        pass
                    else:
                ...
                if self.interwal_dystans_pause <= 100:
                    if self.interwal_dystans_pause == 10 and ope.__name__ == 'sub':
                        pass
                    else:
