...
#===================================== SPEEDOMETER ====================================================#    
    ...
    def wyswietlanie_speedometera(self,obj_menu, obj_licznik,xm,ym,r):
        ...
        if self.speed != obj_licznik.current_speed :                # Jeżeli otrzymaliśmy nową wartość chwilową
            ...
            if self.aktualna_pozycja > 45:
                delta = time.ticks_diff(time.ticks_ms(), start) # compute time difference
                print(' czas:  ' + str(delta) + '  predkosc:    ' + str(self.aktualna_pozycja) + ' srednia:  '+ str(self.aktualna_pozycja*1000/delta))
...
############################################################################################################                           
    ...
    ##############################== Kolor po argumencie i po pozycji ==############################################     
        ...
        if wybor == 0:
            ...
            GREEN = 230 -poz * 0.9
            BLUE  = 30 - poz* 0.1
            return st7789.color565( int(RED*(1- arg/50))  , int(GREEN*(1- arg/50)), int(BLUE*(1- arg/50)))
            ### Tęcza [1] ###
        elif wybor == 1:
