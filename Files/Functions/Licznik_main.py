...
class Licznik_main(): #Główna funkcja
    ...
    flaga, flaga_1, spac,flaga_sen_stop           = False,False,False,False
...
#             print('sin:   ' + str(sin) + '  g_force:  ' + str(g_force))         
...
#################################### KONIEC funckji Przerwania ####################################################    
    ...
    def zaleznosci(speed):
        if speed <= 9:  
            return 1       
        elif speed <=13.63  and speed> 9:
            return 2
        elif speed <= 18.21 and speed>13.63:
            return 3
        elif speed <= 22.86 and speed>18.21:
            return 4
        elif speed <=27.35  and speed> 22.86:
            return 5
        elif speed <32.5    and speed> 27.35:
            return 6
        elif speed <= 37.5  and speed> 30.5:
            return 7
        elif speed <= 43    and speed> 37.5:
            return 8
